...
fun ICorChainDsl<GrschbrContext>.stubUpdateSuccess(title: String, corSettings: GrschbrCorSettings) = worker {
    this.title = title
    this.description = """
        Кейс успеха для изменения основной карточки монеты
    """.trimIndent()
