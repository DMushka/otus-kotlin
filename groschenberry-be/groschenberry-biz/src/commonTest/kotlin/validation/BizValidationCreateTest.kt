...
class BizValidationCreateTest: BaseBizValidationTest() {
    override val command: GrschbrCommand = GrschbrCommand.CREATE
    ...
    @Test fun correctCIBId() = validationCIDIdCorrect(command, processor)
    ...
    @Test fun noneNumericIssueYear() = validationIssueYearNoneNumeric(command, processor)
