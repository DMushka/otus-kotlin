...
class RepoCIDSQLTest {

    class RepoCIDSQLCreateTest : RepoCIDCreateTest() {
    ...
    class RepoCIDSQLReadTest : RepoCIDReadTest() {
    ...
    class RepoCIDSQLUpdateTest : RepoCIDUpdateTest() {
        override val repo = repoUnderTestContainer(
            initObjects,
    ...
    class RepoCIDSQLDeleteTest : RepoCIDDeleteTest() {
        override val repo = repoUnderTestContainer(initObjects)
    ...
    class RepoCIDSQLSearchTest : RepoCIDSearchTest() {
        override val repo = repoUnderTestContainer(initObjects)
