package com.otus.otuskotlin.groschenberry.e2e.be.fixture.docker
 ...
 * dockerComposeNames - имена docker-compose файлов (относительно groschenberry-acceptance/docker-compose)
 */
